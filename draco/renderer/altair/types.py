...
"""
DatasetNumberRows = pydantic.types.PositiveInt
...
"""
FieldUnique = pydantic.types.PositiveInt

"""
The entropy of the field.
Described as `(field,entropy)`
"""
FieldEntropy = pydantic.types.PositiveFloat
...
"""
FieldFreq = pydantic.types.PositiveInt
...
"""
EncodingBinning = pydantic.types.PositiveInt
...
class SchemaBase(pydantic.main.BaseModel):
...
class Encoding(SchemaBase):
    ...
    @pydantic.functional_validators.model_validator(mode="before")
...
class Scale(SchemaBase):
    ...
    type: ScaleType = pydantic.fields.Field(default="linear")
...
class View(SchemaBase):
    ...
    coordinates: ViewCoordinate = pydantic.fields.Field(default="cartesian")
    mark: list[Mark]
...
class Field(SchemaBase):
    ...
    id: FieldId | None = pydantic.fields.Field(default=None, alias="__id__")
    name: FieldName
    type: FieldType
